...
export default function Home() {
  return (
    ...
    <main className="container mx-auto px-4 py-6">
        ...
        <p>Here You can Read the New Trending Articles</p>
    </main>

    <div className="flex justify-end px-4 ">
        <input type="text" className="px-4 py-2 outline-none border border-gray-300 rounded-md" placeholder="Search..." />
        <button className="px-4 py-2  text-white bg-blue-600 rounded-md ml-4">Search</button>
      </div>
